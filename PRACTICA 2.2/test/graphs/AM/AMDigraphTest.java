 ...
 * @author Owner
 */
public class AMDigraphTest {
    
    public AMDigraphTest() {
    }
    ...
    /**
     * Test of vertices method, of class AMDigraph.
     */
    @Test
    public void testEndVertices() {
        System.out.println("opposite");
        Graph<String,Integer> graph = new ALDigraph<> ();
    ...
    public void testOutputEdges() 
    {
        ...
        Edge<Integer> e = graph.insertEdge(v1,v2,495);
        Edge<Integer> e1 = graph.insertEdge(v1,v3,350);        
        graph.insertEdge(v2,v3,190);
