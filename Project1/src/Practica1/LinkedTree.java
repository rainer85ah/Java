...
{    
    ...
    * Devuelve el elemento que habia en esa posicion. Poner el que envias.
    */
    ...
    */
        ...
        throws InvalidPositionException 
    {
        ...
        return (TreeNode<E>) p; //casting de la position por tipo de nodo
    }
    ...
    */
    public Position<E> add(E element, Position<E> p) 
    {
        ...
        List<TreeNode<E>> list = parent.getChildren();
        list.add(newNode);
        size++;
        return newNode;
    }
